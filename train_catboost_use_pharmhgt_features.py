...
then aggregates them into per-molecule feature vectors for CatBoost.
...
# ===========================================================================
# 2. Pharmacophore & Reaction Features (Gbeta)
#   EXACTLY as in pharmhgt_logcmc.py
# ===========================================================================
...
# ===========================================================================
# 4. Feature Vector Construction — per molecule (CatBoost input)
# ===========================================================================
...
# ===========================================================================
# 5. Main - Load Data, Featurize, Train CatBoost with Optuna
# ===========================================================================
...
def main():
    ...
    # Build feature names matching the concatenation order
    names = []
    for i in range(220):
        group = i // 55
        dim = i % 55
